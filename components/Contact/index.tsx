    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          exit={{ opacity: 0 }}
          className="fixed z-20 top-0 w-full h-full right-0 bottom-0 backdrop-blur-[8px] bg-[#00000040] flex flex-col items-center justify-center"
        >
          <motion.div
            initial={{ scaleY: 0 }}
            animate={{ scaleY: 1 }}
            ...
            className="absolute top-0 border-l  left-[1rem] lg:left-[15%] h-full border-[#727272]  z-[11] origin-top"
          />
          <motion.div
            initial={{ scaleY: 0 }}
            animate={{ scaleY: 1 }}
            ...
            className="absolute bottom-0 border-l lg:right-[15%] right-[1rem] h-full border-[#727272]  z-[11] origin-bottom"
          />
          <motion.div
            initial={{ scaleX: 0 }}
            animate={{ scaleX: 1 }}
